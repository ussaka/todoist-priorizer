    ...
    while True:
        ...
        if (
            ...
            if tasks_size < tasks_target_size:
                logging.info(f"You have less than {tasks_target_size} P1 tasks")
            ...
            if tasks_size < tasks_target_size:
                logging.info(f"You have less than {tasks_target_size} P2 tasks")
            ...
            if tasks_size < tasks_target_size:
                logging.info(f"You have less than {tasks_target_size} P3 tasks")
                prioritize_tasks(p2_tasks, 2, tasks_target_size - tasks_size)
        else:
            sleep(60)
